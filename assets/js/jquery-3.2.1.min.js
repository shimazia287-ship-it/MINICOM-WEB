! function(e, t) {
    ...
    var d = function(n) {
        ...
        for (e in h = re.support = {}, s = re.isXML = function(e) {
                ...
                if ((e.ownerDocument || e) !== C && T(e), t = t.replace(U, "='$1']"), h.matchesSelector && k && !j[t + " "] && (!c || !c.test(t)) && (!m || !m.test(t))) try {
                    var n = d.call(e, t);
        ...
        return fe.prototype = b.filters = b.pseudos, b.setFilters = new fe, g = re.tokenize = function(e, t) {
            ...
            if (!o) {
                for (n = (t = t || g(e)).length; n--;)(o = function e(t) {
                    for (var i, n, r, o = t.length, s = b.relative[t[0].type], a = s || b.relative[" "], u = s ? 1 : 0, l = de(function(e) {
                            return e === i
                        }, a, !0), c = de(function(e) {
                            return -1 < P(i, e)
                        ...
                        if (n = b.relative[t[u].type]) f = [de(he(f), n)];
                            ...
                            if ((n = b.filter[t[u].type].apply(null, t[u].matches))[E]) {
                                ...
                                return ve(1 < u && he(f), 1 < u && pe(t.slice(0, u - 1).concat({
                                    value: " " === t[u - 2].type ? "*" : ""
                                })).replace(_, "$1"), n, u < r && e(t.slice(u, r)), r < o && e(t = t.slice(r)), r < o && pe(t))
                            }
                            f.push(n)
                        }
                    return he(f)
                }(t[n]))[E] ? r.push(o) : i.push(o);
    ...
    E.fn.extend({
        ...
        E.fn[r] = function(e, t) {
            ...
            return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = E.filter(t, n)), 1 < this.length && (j[r] || E.uniqueSort(n), D.test(r) && n.reverse()), this.pushStack(n)
        }
    });
    var q, L = /\S+/g;
    ...
    var Ne, Se, De, je, Ae, qe, Le = /^margin/,
    ...
    function Pe() {
        qe.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", qe.innerHTML = "", Fe.appendChild(Ae);
        var e = C.getComputedStyle(qe);
        Ne = "1%" !== e.top, je = "2px" === e.marginLeft, Se = "4px" === e.width, qe.style.marginRight = "50%", De = "4px" === e.marginRight, Fe.removeChild(Ae)
    }

    function Re(e, t, n) {
        var r, i, o, s, a = e.style;
        return "" !== (s = (n = n || Oe(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== s || E.contains(e.ownerDocument, e) || (s = E.style(e, t)), n && !v.pixelMarginRight() && He.test(s) && Le.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    Ae = k.createElement("div"), (qe = k.createElement("div")).style && (qe.style.backgroundClip = "content-box", qe.cloneNode(!0).style.backgroundClip = "", v.clearCloneStyle = "content-box" === qe.style.backgroundClip, Ae.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", Ae.appendChild(qe), E.extend(v, {
        pixelPosition: function() {
            return Pe(), Ne
        },
        boxSizingReliable: function() {
            return null == Se && Pe(), Se
        },
        pixelMarginRight: function() {
            return null == Se && Pe(), De
        },
        reliableMarginLeft: function() {
            return null == Se && Pe(), je
        },
        reliableMarginRight: function() {
            var e, t = qe.appendChild(k.createElement("div"));
            return t.style.cssText = qe.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", t.style.marginRight = t.style.width = "0", qe.style.width = "1px", Fe.appendChild(Ae), e = !parseFloat(C.getComputedStyle(t).marginRight), Fe.removeChild(Ae), qe.removeChild(t), e
        }
    }));
    ...
    function Ve(e, t, n) {
        ...
        if (k.msFullscreenElement && C.top !== C && e.getClientRects().length && (i = Math.round(100 * e.getBoundingClientRect()[t])), i <= 0 || null == i) {
            if (((i = Re(e, t, o)) < 0 || null == i) && (i = e.style[t]), He.test(i)) return i;
    ...
    E.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = E.camelCase(t),
                    u = e.style;
                return t = E.cssProps[a] || (E.cssProps[a] = Xe(a) || a), s = E.cssHooks[t] || E.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : ("string" === (o = typeof n) && (i = X.exec(n)) && i[1] && (n = U(e, t, i), o = "number"), void(null != n && n == n && ("number" === o && (n += i && i[3] || (E.cssNumber[a] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, s, a = E.camelCase(t);
            return t = E.cssProps[a] || (E.cssProps[a] = Xe(a) || a), (s = E.cssHooks[t] || E.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = Re(e, t, r)), "normal" === i && t in $e && (i = $e[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), E.each(["height", "width"], function(e, s) {
        E.cssHooks[s] = {
            get: function(e, t, n) {
                return t ? Ie.test(E.css(e, "display")) && 0 === e.offsetWidth ? Ee(e, We, function() {
                    return Ve(e, s, n)
                }) : Ve(e, s, n) : void 0
            },
            set: function(e, t, n) {
                ...
                return o && (r = X.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, t = E.css(e, s)), ze(0, t, o)
            }
        }
    }), E.cssHooks.marginLeft = Me(v.reliableMarginLeft, function(e, t) {
        return t ? (parseFloat(Re(e, "marginLeft")) || e.getBoundingClientRect().left - Ee(e, {
            marginLeft: 0
        }, function() {
            return e.getBoundingClientRect().left
        })) + "px" : void 0
    }), E.cssHooks.marginRight = Me(v.reliableMarginRight, function(e, t) {
        return t ? Ee(e, {
        ...
        }, Le.test(i) || (E.cssHooks[i + o].set = ze)
    }), E.fn.extend({
        css: function(e, t) {
            return F(this, function(e, t, n) {
                var r, i, o = {},
                    s = 0;
                if (E.isArray(t)) {
                    for (r = Oe(e), i = t.length; s < i; s++) o[t[s]] = E.css(e, t[s], !1, r);
                    return o
                }
        ...
        run: function(e) {
            ...
            return this.options.duration ? this.pos = t = E.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Ge.propHooks._default.set(this), this
        }
        ...
        _default: "swing"
    }, E.fx = Ge.prototype.init, E.fx.step = {};
    var Qe, Je, Ke, Ze, et, tt = /^(?:toggle|show|hide)$/,
        nt = /queueHooks$/;
    ...
    function st(o, e, t) {
        ...
        for (function(e, t) {
            ...
            if (n = st.prefilters[r].call(l, o, c, l.opts)) return E.isFunction(n.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = E.proxy(n.stop, n)), n;
        return E.map(c, ot, l), E.isFunction(l.opts.start) && l.opts.start.call(o, l), E.fx.timer(E.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
    ...
    E.Animation = E.extend(st, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0, i = (e = E.isFunction(e) ? (t = e, ["*"]) : e.match(L)).length; r < i; r++) n = e[r], st.tweeners[n] = st.tweeners[n] || [], st.tweeners[n].unshift(t)
        },
        prefilters: [function(t, e, n) {
            ...
            if (E.isEmptyObject(f)) "inline" === ("none" === l ? ke(t.nodeName) : l) && (p.display = l);
                ...
                for (r in h ? "hidden" in h && (d = h.hidden) : h = R.access(t, "fxshow", {}), o && (h.hidden = !d), d ? E(t).show() : c.done(function() {
                    ...
                    }), f) s = ot(d ? h[r] : 0, r, c), r in h || (h[r] = s.start, d && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }],
        ...
        var e, t = 0,
            n = E.timers;
        for (Qe = E.now(); t < n.length; t++)(e = n[t])() || n[t] !== e || n.splice(t--, 1);
        n.length || E.fx.stop(), Qe = void 0
    }, E.fx.timer = function(e) {
        E.timers.push(e), e() ? E.fx.start() : E.timers.pop()
    }, E.fx.interval = 13, E.fx.start = function() {
        Je = Je || C.setInterval(E.fx.tick, E.fx.interval)
    }, E.fx.stop = function() {
        C.clearInterval(Je), Je = null
    }, E.fx.speeds = {
        slow: 600,
        fast: 200,
        _default: 400
    ...
    }, Ke = k.createElement("input"), Ze = k.createElement("select"), et = Ze.appendChild(k.createElement("option")), Ke.type = "checkbox", v.checkOn = "" !== Ke.value, v.optSelected = et.selected, Ze.disabled = !0, v.optDisabled = !et.disabled, (Ke = k.createElement("input")).value = "t", Ke.type = "radio", v.radioValue = "t" === Ke.value;
    var at, ut = E.expr.attrHandle;
    E.fn.extend({
        attr: function(e, t) {
        ...
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (t = t.toLowerCase(), i = E.attrHooks[t] || (E.expr.match.bool.test(t) ? at : void 0)), void 0 !== n ? null === n ? void E.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = E.find.attr(e, t)) ? void 0 : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        ut[t] = function(e, t, n) {
            var r, i;
            return n || (i = ut[t], ut[t] = r, r = null != o(e, t, n) ? t.toLowerCase() : null, ut[t] = i), r
        }
    });
    ...
    E.fn.extend({
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && "string" == o ? t ? this.addClass(i) : this.removeClass(i) : E.isFunction(i) ? this.each(function(e) {
                ...
                else void 0 !== i && "boolean" != o || ((e = pt(this)) && R.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", !e && !1 !== i && R.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
    ...
    E.extend(E.event, {
        trigger: function(e, t, n, r) {
            var i, o, s, a, u, l, c = [n || k],
                f = h.call(e, "type") ? e.type : e,
                p = h.call(e, "namespace") ? e.namespace.split(".") : [],
                d = o = n = n || k;
            if (3 !== n.nodeType && 8 !== n.nodeType && !gt.test(f + E.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), a = f.indexOf(":") < 0 && "on" + f, (e = e[E.expando] ? e : new E.Event(f, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), l = E.event.special[f] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                if (!r && !l.noBubble && !E.isWindow(n)) {
                    for (s = l.delegateType || f, gt.test(s + f) || (d = d.parentNode); d; d = d.parentNode) c.push(d), o = d;
                ...
                return e.type = f, r || e.isDefaultPrevented() || l._default && !1 !== l._default.apply(c.pop(), t) || !O(n) || a && E.isFunction(n[f]) && !E.isWindow(n) && ((o = n[a]) && (n[a] = null), n[E.event.triggered = f](), E.event.triggered = void 0, o && (n[a] = o)), e.result
            }
        },
    ...
    St.href = vt.href, E.extend({
        ...
        ajaxSetup: function(e, t) {
            return t ? At(At(e, E.ajaxSettings), t) : At(E.ajaxSettings, e)
        },
        ajaxPrefilter: Dt(kt),
        ajaxTransport: Dt(Et),
        ajax: function(e, t) {
            ...
            if (y.promise(T).complete = x.add, T.success = T.done, T.error = T.fail, g.url = ((e || g.url || vt.href) + "").replace(xt, "").replace(Ct, vt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = E.trim(g.dataType || "*").toLowerCase().match(L) || [""], null == g.crossDomain) {
                r = k.createElement("a");
                try {
                    r.href = g.url, r.href, g.crossDomain = St.protocol + "//" + St.host != r.protocol + "//" + r.host
                } catch (e) {
                    g.crossDomain = !0
                }
            }
            if (g.data && g.processData && "string" != typeof g.data && (g.data = E.param(g.data, g.traditional)), jt(kt, g, t, T), 2 === w) return T;
            for (i in (h = E.event && g.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Tt.test(g.type), f = g.url, g.hasContent || (g.data && (f = g.url += (yt.test(f) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (g.url = bt.test(f) ? f.replace(bt, "$1_=" + mt++) : f + (yt.test(f) ? "&" : "?") + "_=" + mt++)), g.ifModified && (E.lastModified[f] && T.setRequestHeader("If-Modified-Since", E.lastModified[f]), E.etag[f] && T.setRequestHeader("If-None-Match", E.etag[f])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && T.setRequestHeader("Content-Type", g.contentType), T.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Nt + "; q=0.01" : "") : g.accepts["*"]), g.headers) T.setRequestHeader(i, g.headers[i]);
    ...
    E.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !E(this).is(":disabled") && Ft.test(this.nodeName) && !Ot.test(e) && (this.checked || !V.test(e))
            }).map(function(e, t) {
                var n = E(this).val();
    ...
    v.cors = !!Rt && "withCredentials" in Rt, v.ajax = Rt = !!Rt, E.ajaxTransport(function(i) {
        var o, s;
        return v.cors || Rt && !i.crossDomain ? {
            send: function(e, t) {
                var n, r = i.xhr();
    ...
    E.ajaxSetup({
        ...
        return s || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = E.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(It, "$1" + r) : !1 !== e.jsonp && (e.url += (yt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return o || E.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", i = C[r], C[r] = function() {
            o = arguments
        }, n.always(function() {
            void 0 === i ? E(C).removeProp(r) : C[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, Mt.push(r)), o && E.isFunction(i) && i(o[0]), o = i = void 0
        }), "script") : void 0
    ...
    E.fn.load = function(e, t, n) {
        ...
        offset: function(t) {
            ...
            var e, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (e = o.documentElement, E.contains(e, r) ? (i = r.getBoundingClientRect(), n = $t(o), {
        ...
        E.cssHooks[n] = Me(v.pixelPosition, function(e, t) {
            return t ? (t = Re(e, n), He.test(t) ? E(e).position()[n] + "px" : t) : void 0
        })
    }), E.each({
        Height: "height",
        Width: "width"
    ...
    return E.noConflict = function(e) {
        return C.$ === E && (C.$ = _t), e && C.jQuery === E && (C.jQuery = Bt), E
    }, e || (C.jQuery = C.$ = E), E
});